...
echo "   💬 Discord: /resolve_privacy, /resolve_speed, /resolve_simple, /resolve_sovereign"
...
echo "   4. Cloud Vendor Lock-in → $0 switching fees (infrastructure only)"
echo "   ... (26 more in contradictions.json)"

...
gcloud container clusters get-credentials red-team --region us-central1
```
...
kubectl config use-context red-team
...
| 2025-12-01 | Red Team cluster renamed from autopilot-cluster-1 to red-team |
| 2025-12-01 | Both clusters registered to GKE Fleet |

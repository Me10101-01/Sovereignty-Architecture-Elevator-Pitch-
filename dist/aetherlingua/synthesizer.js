...
export class AudioSynthesizer {
    ...
    static LINE_CARRIERS = [110.0, 138.59, 174.61, 220.0, 277.18, 349.23];
     ...
     */
    static renderLine(text, carrier, config) {
     ...
     */
    static applyReverb(buffer, sampleRate) {
        const delays = [
